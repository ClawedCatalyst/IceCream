...
studentno_regex = "^((22)(((11|12|14|10|13|00|31|21|32|40|153|154|164|169)[0-9][0-9][0-9])|((154|153|164)[0-9][0-9])))|((2[12])(((11|12|14|10|13|00|31|21|32|40|153|154|164|169)[0-9][0-9][0-9])|((154|153|164)[0-9][0-9]))(-{0,1})[mMdDlL])$"
email_regex = "^[a-zA-Z]+(((22)(((11|12|14|10|13|00|31|21|32|40|153|154|164|169)[0-9][0-9][0-9])|((154|153|164)[0-9][0-9])))|((2[12])(((11|12|14|10|13|00|31|21|32|40|153|154|164|169)[0-9][0-9][0-9])|((154|153|164)[0-9][0-9]))(-{0,1})[mMdDlL]))(@akgec.ac.in)$"
...
class RegistrationForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = [
                    ...
                    'gender','domain','skills','hacker_rank_username', 'github_username', 'captcha',
                     'is_hosteler'
                ]
    ...
    def clean(self):
        ...
        print(cleaned_data['student_number'])
        print(year)
