from .views import IndexView,  BlogView, BlogDetailView, SaveContactView, FeedbackView, AlumniView, EmailTemplatesView, RegistrationView
...
urlpatterns = [
    ...
    # url(r'^submit', RegistrationView.as_view(), name='registration'),
